...
void handleResetHomeKit() {
  ...
  server.send(200, "text/html", "<meta charset='UTF-8'><meta name='viewport'content='width=device-width, initial-scale=1.0, user-scalable=no'>恢复出厂设置成功，设备正在重启");
  delay(2000);
  Serial.println("准备重启中...");
  Serial.println();
